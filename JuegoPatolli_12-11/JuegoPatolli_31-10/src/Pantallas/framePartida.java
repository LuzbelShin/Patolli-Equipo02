...
import POJO.Tablero;
import dibujo.CnvFicha;
import dibujo.CnvTablero;
...
public class framePartida extends javax.swing.JFrame {
    ...
    private CnvFicha canvasFicha;
    
    /**
     * Creates new form tablero
     */
    public framePartida() {            
//        cnvTablero  = new CnvTablero();
...
//        canvasFicha.repaint();
    ...
    private void dibujaFicha(){
        canvasFicha = new CnvFicha();
        Jugador j1 = new Jugador();
        j1.setColor(Color.decode("#bdb2ff"));
        j1.setNumJugador(1);
        Ficha f = new Ficha();
        f.setPosicionX(10d);
        f.setPosicionY(10d);
        Tablero tablero = new Tablero();
        tablero.setCantidadCasillas(cnvTablero.getCasillas());
        canvasFicha.setTablero(tablero);
        canvasFicha.setJugador(j1);
        canvasFicha.setFicha(f);
        canvasFicha.repaint();
        this.add(canvasFicha);
    }
